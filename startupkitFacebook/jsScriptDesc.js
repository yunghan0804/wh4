...
//以下為canvas的程式碼，基本上不需多動，依據comments修改即可
	...
	ctx.fillText("Click here to tart fill with Facebook Profile Picture", 40, 270); //設定預設的開始畫面
    var img = new Image(http://media-cache-ak0.pinimg.com/736x/b8/00/26/b80026319b26c4c0f1672225643c82e0.jpg); // 新增圖像1
    img.src = "img/overlay.png"; //圖像路徑（路徑自己設，且自己加入想要的圖層）
	var img2 = new Image(http://media-cache-ec0.pinimg.com/736x/1d/4e/1a/1d4e1a6fe35e503d4a7f5c2c7b15eb0d.jpg); //新增圖像2
	img2.src = "img/overlayback.png" //圖像路徑
	var img3 = new Image(http://media-cache-ak0.pinimg.com/736x/6a/38/4c/6a384ca9950122dd15e3a3ed73bc6c43.jpg);//新增圖像3
